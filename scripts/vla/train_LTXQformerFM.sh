...
# Usage: bash scripts/vla/train_LTXQformerFM.sh [data_mix] [run_id_suffix] [extra_args...]
# Example: bash scripts/vla/train_LTXQformerFM.sh aloha_wipe_board_notac debug --trainer.max_train_steps 1000
...
accelerate launch \
  ...
  --framework.video_model.num_frames 12 \
