#!/bin/bash
# Multi-GPU WanMoTJoint_TacGate training script (DeepSpeed ZeRO-2)
# Usage: bash WanMoTJoint_TacGate.sh [data_mix] [run_id_suffix] [extra_args...]
# Example: bash WanMoTJoint_TacGate.sh libero_all "debug" trainer.max_train_steps=1000
...
###########################################################################################
# === Configuration ===
Framework_name=WanMoTJoint_TacGate
freeze_module_list=''
