#!/bin/bash
# Multi-GPU LTXFM LIBERO training script (DeepSpeed ZeRO-2).
# Usage: bash scripts/vla/train_LTXFM-libero.sh [data_mix] [run_id_suffix] [extra_args...]
# Example: bash scripts/vla/train_LTXFM-libero.sh libero_all_multi debug --trainer.max_train_steps 1000
