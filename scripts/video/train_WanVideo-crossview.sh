...
###########################################################################################
# === Configuration ===
Framework_name=MultiViewWanVideo
freeze_module_list=''
config_yaml=starVLA/config/training/video/starvla_video_multiview.yaml
...
accelerate launch \
  ...
  --framework.wan_video.target_height 256 \
  --framework.wan_video.target_width 256 \
